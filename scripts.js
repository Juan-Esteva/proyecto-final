...
.then ((data) => {
    ...
    for (let character of characters) {
        ...
        <p><span class="destacado">Género: </span> ${character.gender}</p>
        <p><span class="destacado">Especie: </span> ${character.species}</p>
        <p><span class="destacado">Estado: </span> ${character.status}</p>
        </div>
        </div>
        `}
    })